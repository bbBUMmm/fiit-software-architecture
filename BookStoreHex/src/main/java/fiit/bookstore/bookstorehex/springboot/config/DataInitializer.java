 ...
 * In hexagonal architecture, this is part of the infrastructure/springboot layer.
 */
@Configuration
public class DataInitializer {
    ...
    CommandLineRunner initDatabase(BookRepository bookRepository) {
        return args -> {
            ...
            logger.info("Database initialized with {} sample books", bookRepository.findAll().size());
        };
    }
}
